...
class FamilyExpensePortal(http.Controller):
    ...
    def _base_values(self, **extra):
        ...
        values = {"app_cards": apps, "page_name": extra.get("page_name", "expenses"), "page_title": extra.get("page_title", "Family Expense"), "page_subtitle": extra.get("page_subtitle", ""), "back_url": extra.get("back_url", "/my/apps")}
        values.update(extra)
        return values
